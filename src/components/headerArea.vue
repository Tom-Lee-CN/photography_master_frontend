<template>
  <div :class="{ 'header-container': true }">
    <div :class="{ 'header-box': true }">
      <div :class="{ 'header-left': true }">
        <a href="javascript:;">摄影大师</a>
      </div>
      <div :class="{ 'header-right': true }">
        <span :class="{ 'search-container': true }">
